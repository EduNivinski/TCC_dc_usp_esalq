...
pacotes <- c("plotly","tidyverse","reshape2","knitr","kableExtra","rgl","car",
             ...
             "ggrepel","fastDummies","knitr","kableExtra", "splines",
             "PerformanceAnalytics","metan","correlation", "see",
             "ggraph","nortest","olsrr","jtools","ggstance",
             "magick","cowplot","beepr","Rcpp","cluster", "dendextend",
             "factoextra", "fpc", "gridExtra" )
...
# função para as estimações de HML2 e HML3
